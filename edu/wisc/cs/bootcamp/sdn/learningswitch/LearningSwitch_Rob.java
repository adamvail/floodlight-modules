...
*/
public class LearningSwitch_Rob implements IOFMessageListener, IFloodlightModule, IOFSwitchListener {
	...
	public String getName() {
		return LearningSwitch_Rob.class.getSimpleName();
	}
	...
	public void init(FloodlightModuleContext context)
		...
		logger    		   = LoggerFactory.getLogger(LearningSwitch_Rob.class);
	}
...
// 			match.setNetworkTypeOfService(match.getNetworkTypeOfService());
 			...
 			// specify timers for the life of the rule
 			rule.setIdleTimeout(LearningSwitch_Rob.FLOWMOD_DEFAULT_IDLE_TIMEOUT);
 			rule.setHardTimeout(LearningSwitch_Rob.FLOWMOD_DEFAULT_HARD_TIMEOUT);
 ...
 //       Ethernet eth = IFloodlightProviderService.bcStore.get(cntx, IFloodlightProviderService.CONTEXT_PI_PAYLOAD);
		...
		switch (msg.getType()) {
			...
			case PACKET_IN:
				...
				if (LearningSwitch_Rob.CTRL_LEVEL == 1)
					return this.ctrlLogicHub(sw, (OFPacketIn) msg);
				else if (LearningSwitch_Rob.CTRL_LEVEL == 2)
					return this.ctrlLogicWithoutRules(sw, (OFPacketIn) msg);					
				else if (LearningSwitch_Rob.CTRL_LEVEL == 3)
					return this.ctrlLogicWithRules(sw, (OFPacketIn) msg);
				else if (LearningSwitch_Rob.CTRL_LEVEL == 4)
